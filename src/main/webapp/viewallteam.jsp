...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="player" items="${teams}">
                    <tr>
                        <td>${player.getName()}</td>
                        <td>${player.isStatus()}</td>
                        <td>${player.getWallet()}</td>
                        <td><a href="addamount.jsp?id=${player.getId()}" class="btn change-status-btn">Add Amount</a></td>
                        <td>
                            <a href="changestatus?id=${player.getId()}" class="btn change-status-btn">Change Status</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
